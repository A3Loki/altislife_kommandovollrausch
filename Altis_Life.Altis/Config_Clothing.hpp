...
class Clothing {
	class bruce {
		...
		uniforms[] = {
			...
			{ "U_C_Poloshirt_burgundy",     "Poloshirt | Burgund",              275, { "", "", -1 } },
			{ "U_C_Poloshirt_redwhite",     "Poloshirt | Rot/Weiss",            150, { "", "", -1 } },
			...
			{ "U_IG_Guerilla3_1",           "Braune Jacke & Hose",              735, { "", "", -1 } },
			{ "U_IG_Guerilla2_3",           "Der Hinterland Rangler",           1200, { "", "", -1 } },
			{ "U_C_HunterBody_grn",         "Das Jägeroutfit",                  1500, { "", "", -1 } },
			{ "U_C_WorkerCoveralls",        "Mechaniker Kleidung",              2500, { "", "", -1 } },
			{ "U_OrestesBody",              "Surferkleidung",                   1100, { "", "", -1 } },
			{ "U_NikosAgedBody",            "Bürokaufmann",                     5000, { "", "", -1 } },
			{ "U_NikosBody",                "Niko's Klamotten",                 5000, { "", "", -1 } },
			{ "U_Marshal",                  "Marschall Klamotten",              1100, { "", "", -1 } },
			{ "U_C_Journalist",             "Presse Kleidung",                  2500, { "", "", -1 } }
		};
		...
		headgear[] = {
			...
			{ "H_Bandanna_gry",             "Graues Bandanna",  150, { "", "", -1 } },
			{ "H_Bandanna_cbr",             "",                 165, { "", "", -1 } },
			{ "H_Bandanna_surfer",          "",                 135, { "", "", -1 } },
			{ "H_Bandanna_khk",             "Khaki Bandanna",   145, { "", "", -1 } },
			{ "H_Bandanna_sgg",             "Salbei Bandanna",  160, { "", "", -1 } },
			{ "H_StrawHat",                 "Stroh Fedora",     225, { "", "", -1 } },
	...
	class cop {
		...
		headgear[] = {
			...
			{ "H_PilotHelmetHeli_B",        "",                 500 , { "life_coplevel", "SCALAR", 10 } },
			{ "H_CrewHelmetHeli_B",         "",                 500 , { "life_coplevel", "SCALAR", 10 } },
			{ "H_HelmetB",                  "",                 105 , { "life_coplevel", "SCALAR", 10 } },
            { "H_HelmetB_plain_blk",        "",                 115 , { "life_coplevel", "SCALAR", 10 } },
			{ "H_HelmetB_plain_blk",        "",                 200 , { "life_coplevel", "SCALAR", 10 } },
			{ "H_HelmetSpecB_blk",          "",                 300 , { "life_coplevel", "SCALAR", 10 } }
		};
		...
		goggles[] = {
			...
			{ "G_Aviator",                  "",                 150, { "", "", -1 } },
			{ "G_Lowprofile",               "",                 30, { "", "", -1 } },
			{ "G_Balaclava_blk",            "",                 150, { "life_coplevel", "SCALAR", 10 } },
			{ "G_Tactical_Clear",           "",                 150, { "life_coplevel", "SCALAR", 10 } },
			{ "G_Combat",                   "",                 55, { "life_coplevel", "SCALAR", 10 } }
		};
