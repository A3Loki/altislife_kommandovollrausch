...
/*
Motombo´s Work in Progress
if((nearestObject [getpos player,"Land_fs_feed_F"]) == _curTarget) then {
	[] call life_fnc_TankeInterActionMenu;
};
*/
...
if(isPlayer _curTarget && player distance _curTarget < 3 && _curTarget isKindOf "Man") then {
