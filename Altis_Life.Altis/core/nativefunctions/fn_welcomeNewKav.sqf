...
if ( !license_civ_ausweis && playerSide == civilian) then {
	...
	[
		...
		"Es sieht so aus als wärst du neu hier, begib dich am besten erst einmal zum Einwohnermeldeamt, um dort deinen Ausweis und somit die Staatsbürgerschaft von Altis zu erhalten.",
...
if ( license_civ_ausweis && playerSide == civilian) then {
	...
	[
		...
		"Besorg dir am besten zuerst ein Fahrzeug und einen Job um etwas Geld für die Reise nach Selakano zu machen",
