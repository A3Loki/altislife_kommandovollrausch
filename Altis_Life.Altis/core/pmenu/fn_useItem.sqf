...
switch (true) do {
	...
	case (_item in ["apple","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle","turtlesoup","donut","tbacon","peach","rabbit_grilled","hamburger","cheeseburger","gyrosteller"]): {
