...
switch (true) do {
	case (_item in ["waterBottle","coffee","redgull","cocacola","fanta","sprite"]): {
	...
	case (_item in ["apple","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle","turtlesoup","donuts","tbacon","peach","rabbit_grilled","hamburger","cheeseburger","gyrosteller"]): {
