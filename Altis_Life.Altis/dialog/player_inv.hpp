...
class playerSettings {
	...
	class controls {
		...
		class ButtonSettings: life_RscButtonMenu
		{
			...
			onButtonClick = "createDialog ""Life_nativeConfigs""; ";
		...
		class ButtonCell: life_RscButtonMenu
		{
			...
			w = 0.028875 * safezoneW;
			h = 0.0504 * safezoneH;
			onButtonClick = "[] call life_fnc_cellPhoneHandler;";
		...
		*/
		/*
		class ButtonStvo_ICON: life_RscPicture
		{
			idc = 100054;
		...
		class ButtonStvo: life_RscButtonMenu
		{
			idc = 100045;
			x = 0.546406 * safezoneW + safezoneX;
			y = 0.566 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.077 * safezoneH;
			onButtonClick = "createDialog ""Life_My_Stvo_Diag"";";
			tooltip = "StVO";
			colorBackground[] = {-1,-1,-1,-1};
			colorBackgroundFocused[] = {1,1,1,0.12};
			colorBackground2[] = {0.75,0.75,0.75,0.2};
		...
		*/
		...
		class ButtonCraft: life_RscButtonMenu
		{
			...
			w = 0.028875 * safezoneW;
			h = 0.0504 * safezoneH;
			onButtonClick = "createDialog ""Life_myColor"";";
			tooltip = "Color";
			colorBackground[] = {-1,-1,-1,-1};
			colorBackgroundFocused[] = {1,1,1,0.12};
			colorBackground2[] = {0.75,0.75,0.75,0.2};
		...
		*/
		/*
		class ButtonPack_ICON: RscPicture
		{
			idc = 1207;
			text = "images\tablet\Verpacken.paa";
		...
		class ButtonPack: life_RscButtonMenu
		{
			...
			w = 0.0309375 * safezoneW;
			h = 0.055 * safezoneH;
			onButtonClick = "closeDialog 0; [] spawn life_fnc_vitem_openPackDialog;";
			tooltip = "Verpacken";
			colorBackground[] = {-1,-1,-1,-1};
			colorBackgroundFocused[] = {1,1,1,0.12};
			colorBackground2[] = {0.75,0.75,0.75,0.2};
		...
		class ButtonCraft_ICON: RscPicture
		{
			idc = 100054;
			text = "images\tablet\Baumenue.paa";
		...
		class ButtonCraft: life_RscButtonMenu
		{
			...
			w = 0.0309375 * safezoneW;
			h = 0.055 * safezoneH;
			onButtonClick = "closeDialog 0; [] call life_fnc_fabrikPruefung;";
			tooltip = "Baumenü";
			colorBackground[] = {-1,-1,-1,-1};
			colorBackgroundFocused[] = {1,1,1,0.12};
			colorBackground2[] = {0.75,0.75,0.75,0.2};
		...
		class ButtonCraftDonator: life_RscButtonMenu
		{
			idc = 100002;
			x = 0.345312 * safezoneW + safezoneX;
			y = 0.643 * safezoneH + safezoneY;
		...
		*/
		...
		/*
		class ButtonTalentbaum_ICON: RscPicture
		{
			idc = 100055;
			text = "images\tablet\talentbaum.paa";
			x = 0.380156 * safezoneW + safezoneX;
			y = 0.566 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.077 * safezoneH;
		};
		
		class ButtonTalentbaum: life_RscButtonMenu
		{
			idc = 100056;
			x = 0.385312 * safezoneW + safezoneX;
			y = 0.577 * safezoneH + safezoneY;
			w = 0.0309375 * safezoneW;
			h = 0.055 * safezoneH;
			onButtonClick = "[] spawn life_fnc_talentbaum;";
			tooltip = $STR_PM_talentbaum;
			colorBackground[] = {-1,-1,-1,-1};
			colorBackgroundFocused[] = {1,1,1,0.12};
			colorBackground2[] = {0.75,0.75,0.75,0.2};
			color[] = {1,1,1,1};
